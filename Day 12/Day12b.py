def runGenerations(rules, plants, iterations): #thanks to Danksalot2000 from reddit
...
with open('Day12Pots.txt') as inFile:
	lines = inFile.read().splitlines()
	plants = [i for i, c in enumerate(lines[0][15:]) if c == "#"]
	rules = dict((line[:5], line[9] == "#") for line in lines[2:])

print('Part 1:', runGenerations(rules, plants, 20)) #for part 2 find a pattern should be somewhere around 100s
print('Part 2:', runGenerations(rules, plants, 200) + ((50000000000 - 200) * 23))
